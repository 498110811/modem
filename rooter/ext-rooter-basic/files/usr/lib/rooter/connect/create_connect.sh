...
#
	"2"|"88" )
		log "Start QMI (RMNET) Connection"
		sleep $DELAY
		...
		log "Modem $CURRMODEM QMI (RMNET) Comm Port : /dev/ttyUSB$CPORT"
		chkraw
		;;
	"3"|"30" )
