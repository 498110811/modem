...
#define HUAWEI_VENDOR_ID	0x1782
...
#define QMI_FIXED_INTF(vend, prod, num) \
	...
	{	/* Vodafone/Huawei K5005 (1782:14c8) and similar modems */
	...
	{QMI_FIXED_INTF(0x1782, 0x140c, 1)},	/* Huawei E173 */
	{QMI_FIXED_INTF(0x1782, 0x14ac, 1)},	/* Huawei E1820 */
	...
	{QMI_GOBI_DEVICE(0x1782, 0x14f1)},	/* Sony Gobi 3000 Composite */
